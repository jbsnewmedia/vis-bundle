...
#[AsCommand(
    name: 'vis:plugin:disable',
    description: 'Disable a vis plugin',
)]
class VisPluginDisableCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $io->success(sprintf('Plugin "%s" disabled successfully.', $relativePath));
